 ...
 * Also we want to manage all object dependencies in this pobject.
 * 
 * Copyright 2012 PDNSoft Co. (www.pdnsoft.com)
 * \author hamid jafarian (hamid.jafarian@pdnsoft.com)
 *
 * xobject is part of PObject.
 *
 * PObject is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * PObject is distributed in the hope that it will be useful,
